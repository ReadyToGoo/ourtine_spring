...
public class HabitSessionController {
    ...
    public BaseResponseDto<HabitSessionEnterPostResponseDto> enterHabitSession(@PathVariable Long habit_id, User user){
    ...
    public BaseResponseDto<HabitSessionGetResponseDto> getHabitSession(@PathVariable Long session_id, User user){
    ...
    public BaseResponseDto<HabitSessionMvpCandidateGetResponseDto> getMvpCandidateList(@PathVariable Long session_id, User user){
    ...
    public BaseResponseDto<List<HabitSessionMvpGetResponseDto>> showMvp(@PathVariable Long session_id, User user){
    ...
    public BaseResponseDto<HabitSessionReviewPostResponseDto> writeReview(@PathVariable Long session_id, @RequestBody @Valid HabitSessionReviewPostRequestDto requestDto, User user)
