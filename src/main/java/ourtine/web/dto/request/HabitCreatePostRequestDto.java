...
public class HabitCreatePostRequestDto {
        ...
        @Size(min = 10, max = 100, message = "소개글은 10자 이상이어야 합니다.")
        ...
        @Positive(message = "인원 수는 자연수만 입력가능합니다.")
        ...
        private List<@Min(value = 2, message = "해시태그는 2자 이상 10자 이하여야 합니다.")@Max(value = 10, message = "해시태그는 2자 이상 10자 이하여야 합니다. ")
