...
public class FollowController {
    ...
    public BaseResponseDto<SliceResponseDto<FollowingsGetResponseDto>> getMyFollowings(User user, Pageable pageable){
    ...
    public BaseResponseDto<SliceResponseDto<FollowersGetResponseDto>> getMyFollowers(User user, Pageable pageable){
    ...
    public BaseResponseDto<SliceResponseDto<FollowingsGetResponseDto>> getFollowings(@PathVariable Long user_id, User user,Pageable pageable){
    ...
    public BaseResponseDto<SliceResponseDto<FollowersGetResponseDto>> getFollowers(@PathVariable Long user_id, User user,Pageable pageable){
